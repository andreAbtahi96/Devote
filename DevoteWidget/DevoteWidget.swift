...
//  DevoteWidget
//
//  Created by Andre Abtahi on 8/27/21.
//
...
struct DevoteWidgetEntryView : View {
    ...
    /*
     This environment property and family key let's us get any actual size of any widget instance. We can also use this to understand current config and change views.
     */
